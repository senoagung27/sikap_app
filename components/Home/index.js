      ...
      return (
        ...
        />
          ...
          <Button vertical active={props.navigationState.index === 1}
              onPress={() => props.navigation.navigate("Profile")} style={{backgroundColor:'#2AC4F3'}}>
            <Image
        ...
        />
          ...
          <Button vertical active={props.navigationState.index === 2}
              onPress={() => props.navigation.navigate("Pesan")} style={{backgroundColor:'#2AC4F3'}}>
           <Image
          style={{width: 50, height: 50}}
        ...
        />
          ...
          <Button vertical active={props.navigationState.index === 3}
              onPress={() => props.navigation.navigate("Setting")} style={{backgroundColor:'#2AC4F3'}}>
            <Icon name="settings" />
            <Text>Setting</Text>
          </Button>
        </FooterTab>
