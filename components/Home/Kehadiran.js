        ...
        <Content style={{ backgroundColor: "white" }}>
          ...
          <List>
            <Card style={{ flex: 0 }}>
              <CardItem style={{ backgroundColor: "#00aeef" }}>
                <Left>
                  <Thumbnail
                    ...
                    source={{ uri: "https://i.imgur.com/XS0Dn1t.png" }}
                  />
                  <Body>
                ...
                <Body>
                  ...
                  >
                    <Body>
                      ...
                      <Text style={{ top: 20, left: 40 }}>KIMIA</Text>
                    </Body>
                  </CardItem>
                  <Text note style={{ left: 170, bottom: 20, fontSize: 12 }}>
                    PEMAHAMAN
                  </Text>
                  <Text note style={{ left: 170, bottom: 10, fontSize: 12 }}>
                    KEAKTIFAN
                  </Text>
                  <Text
                    style={{
              ...
              <Text style={{ backgroundColor: "#cfeef9" }}>
                ...
                <Body>
                  ...
                  >
                    <Body>
                      ...
                      />
                      <Text style={{ top: 10, left: 20 }}>MENURUN</Text>
                      <Text style={{ top: 20, left: 10 }}>MATEMATIKA</Text>
                    </Body>
                  </CardItem>
                  <Text note style={{ left: 170, bottom: 50, fontSize: 12 }}>
                    PEMAHAMAN
                  </Text>
                  <Text note style={{ left: 170, bottom: 40, fontSize: 12 }}>
                    KEAKTIFAN
                  </Text>
                  <Text
                    style={{
              ...
              <CardItem style={{ backgroundColor: "#00aeef" }}>
                <Left>
                  <Thumbnail
                    square
                    style={{ width: 50, height: 50 }}
                    source={{ uri: "https://i.imgur.com/aBRqbq1.png" }}
                  />
                  <Body>
